...
class LoopTree final {
  public:
    ...
    bool is_header(vertex_handler v) const { return header_to_loop_.contains(v); }
    ...
    std::ranges::forward_range auto headers() const { return header_to_loop_ | std::views::keys; }
